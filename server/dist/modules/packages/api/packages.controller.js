...
let PackagesController = class PackagesController {
    packagesUseCase;
    constructor(packagesUseCase) {
        this.packagesUseCase = packagesUseCase;
    }
    create(data) {
...
__decorate([
    (0, common_1.Post)(),
    (0, permissions_decorator_1.Permissions)('system:packages:create'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.Permissions)('system:packages:read'),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, permissions_decorator_1.Permissions)('system:packages:update'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('system:packages:delete'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
...
exports.PackagesController = PackagesController = __decorate([
    ...
    __metadata("design:paramtypes", [packages_usecase_1.PackagesUseCase])
], PackagesController);
